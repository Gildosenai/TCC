...
// Verifica se o usuário é um leitor
if ($usuario['PermissaoID'] == 3) { // Verifica se é leitor 
  // Impede o acesso a áreas restritas
  echo "Você não tem permissão para acessar esta página.";
  exit();
}

// Array de mapeamento de permissões
$permissoes = [
  1 => 'Administrador',
  2 => 'Operador',
  3 => 'Leitor'
...
// Verifica se o ID de permissão existe no array e define o nome da permissão
$nomePermissao = isset($permissoes[$usuario['PermissaoID']]) ? $permissoes[$usuario['PermissaoID']] : 'Permissão desconhecida';
...
<html lang="pt-br">
  ...
  <body>
    ...
    <div class="sidebar">
      <div  class="menu-item" id="menucadastro"><svg
            xmlns="http://www.w3.org/2000/svg"
            xmlns:xlink="http://www.w3.org/1999/xlink"
            width="100px"
            zoomAndPan="magnify"
          ...
          >
            <defs>
              <clipPath id="b87f7d960f">
                <path
                  d="M 7.113281 13.875 L 796.113281 13.875 L 796.113281 802.875 L 7.113281 802.875 Z M 7.113281 13.875 "
                  clip-rule="nonzero"
                />
              </clipPath>
            </defs>
            <g clip-path="url(#b87f7d960f)">
              <path
                fill="#ffffff"
                d="M 714.261719 432.875 L 714.261719 660.035156 C 714.261719 738.660156 650.023438 802.898438 571.398438 802.898438 L 150.027344 802.898438 C 71.40625 802.898438 7.164062 738.660156 7.164062 660.035156 L 7.164062 238.664062 C 7.164062 160.042969 71.40625 95.800781 150.027344 95.800781 L 377.191406 95.800781 L 377.191406 147.425781 L 150.027344 147.425781 C 99.894531 147.425781 58.789062 188.527344 58.789062 238.664062 L 58.789062 660.035156 C 58.789062 710.171875 99.894531 751.273438 150.027344 751.273438 L 571.398438 751.273438 C 621.511719 751.273438 662.613281 710.171875 662.613281 660.035156 L 662.613281 432.875 Z M 650.273438 266.066406 L 544 159.789062 L 293.851562 409.9375 L 400.125 516.214844 Z M 580.507812 123.277344 L 686.785156 229.554688 L 723.144531 193.222656 L 616.84375 86.917969 Z M 345.878906 534.960938 L 275.101562 464.1875 L 262.183594 547.878906 Z M 404.0625 578.234375 L 200.390625 609.648438 L 233.089844 397.625 C 360.992188 269.699219 488.890625 141.800781 616.816406 13.898438 L 796.113281 193.195312 C 668.214844 321.097656 540.289062 448.996094 412.390625 576.921875 L 404.039062 578.210938 Z M 404.0625 578.234375 "
                fill-opacity="1"
                fill-rule="nonzero"
              />
            </g>
          </svg>
          <span>CADASTRO</span> </>       <!--link do poup editar linha-->
    ...
    <div id="modalcadastro" class="modalcadastro">
      <div class="modal-content-cadastro">
        <span id="close" class="fechar">&times;</span>
      ...
      <div class="modal-content-cad-cliente">
        ...
        <form action="cadastroCliente.php" method="post">
            ...
            <div class="form-group1">
              ...
              <input type="password" class="cliente-senha" id="senha" name="senha" placeholder="Senha" required>
    ...
    <div id="modalfuncionario" class="modal">
      <div class="modal-content-cad-funcionario">
        ...
        <form action="cadastroFuncionario.php" method="post">
          ...
          <div class="form-group-func3">
          <input type="text" class="func-permissoes" id="permissoes" name="permissoes" placeholder="Permissões deste Funcionário" >
          <input type="password" class="func-senha" id="senha" name="senha" placeholder="Senha" required>
          </div>
          <button type="submit">CADASTRAR</button>
      </form>
    ...
    <div id="modalequipamento" class="modal">
      <div class="modal-content-cad-equipamento">
        ...
        <form action="CadastroEquip.php" method="post">
          ...
          <button class="btn-equip" type="submit" >CADASTRAR</button>
      </form>
...
<div id="iframe-container" style="margin-top: 20px;">
  ...
  <div class="modal-content-usuario">
    ...
    <div class="container123">
      ...
      <p><strong>Permissão:</strong> <?php echo htmlspecialchars($nomePermissao); ?></p>
