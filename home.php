  ...
  <body>
    ...
    <header>
      ...
      <div class="ret1"><h1>HOSTHUB</h1></div>
          ...
          <button type="submit" class="lupa"><svg class="lulu" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="#fff">
      ...
      <div class="modal-content-cad-equipamento">
        ...
        <form action="CadastroEquip.php" method="post">
          ...
          <div class="form-group-equip2" id="equip">
            ...
            <input type="radio" class="" id="funcionario" name="tipo_usuario" value="funcionario" required>
...
<div id="iframe-container" style="margin-top: 20px;">
  ...
  <iframe id="iframe-31" width=70% heigth=10% frameborder="0"></iframe>
    ...
    <div class="container123">
      ...
      <p><strong>Permissão:</strong> <?php echo "Administrador" ?></p>
