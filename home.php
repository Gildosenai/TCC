  ...
  <body>
    ...
    <div id="modalhostindividual" class="modalhostindividual">
      <div class="modal-content-individual">
        ...
        <div id="iframe-container" style="margin-top: 20px;">
          <iframe id="iframe-display" width="750" height="200" frameborder="0"></iframe>
        </div>
        <div id="iframe-container" style="margin-top: 20px;">
          <iframe id="iframe-display1" width="700" height="200" frameborder="0"></iframe>
        </div>
        <div id="iframe-container" style="margin-top: 20px;">
          <iframe id="iframe-display2" width="700" height="200" frameborder="0"></iframe>
        </div>
        <div id="iframe-container" style="margin-top: 20px;">
          <iframe id="iframe-display3" width="700" height="200" frameborder="0"></iframe>
        </div>
        <div id="iframe-container" style="margin-top: 20px;">
          <iframe id="iframe-display4" width="700" height="200" frameborder="0"></iframe>
        </div>
        <div id="iframe-container" style="margin-top: 20px;">
          <iframe id="iframe-display5" width="700" height="200" frameborder="0"></iframe>
        </div>
        <div id="iframe-container" style="margin-top: 20px;">
          <iframe id="iframe-display6" width="700" height="200" frameborder="0"></iframe>
        </div>

        <div id="iframe-container" style="margin-top: 20px;">
          <iframe id="iframe-display7" width="700" height="200" frameborder="0"></iframe>
        </div>

        <div id="iframe-container" style="margin-top: 20px;">
          <iframe id="iframe-display8" width="700" height="200" frameborder="0"></iframe>
        </div>
